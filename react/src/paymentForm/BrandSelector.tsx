...
export const InlineBrandSelector = ({
    ...
    if (brands.length === 1) {
        ...
        return (
            <div className="flex px-4 py-2 items-center text-sm text-gray-600">
                ...
                <span aria-label={brands[0]} title={brands[0]} className="ml-2 flex items-center">
                    <img
    ...
    return (
        <div className="flex px-4 py-2 items-center text-sm text-gray-600">
            ...
            <fieldset style={{border: "none", padding: 0, margin: 0}} aria-labelledby="brand-label">
                <legend className="sr-only">Select card brand</legend>
                <div role="radiogroup" aria-labelledby="brand-label" className="flex space-x-4 ml-4">
                    {brands.map((brand) => (
                        <label
                            key={brand}
